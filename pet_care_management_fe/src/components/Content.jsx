...
import shape1 from '../assets/img/gallery/shape1.png';
...
import testiLogo from '../assets/img/gallery/testi-logo.png';
import sectionBg03 from '../assets/img/gallery/section_bg03.png';
...
const Content = () => {
 ...
 Contact Now<i className="ti-arrow-right"></i>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-xl-7 col-lg-8 col-md-10 ">
                                    {/* Video icon */}
                                    <div className="video-icon">
                                        <a className="popup-video btn-icon" href="https://www.youtube.com/watch?v=1aP-TXUpNoU" data-animation="bounceIn" data-delay=".4s">
                                            <i className="fas fa-play"></i>
                                        </a>
                                    </div>
                                    <div className="hero__caption">
                ...
                <div className="about-img">
                    <div className="info-man text-center">
                        <div className="head-cap">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="28px" height="39px">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-gallery mb-30">
                                <div className="gallery-img size-img" style={{ backgroundImage: `url(${gallery1})`}}></div>
                            </div>
                        </div>
                        <div className="col-lg-8 col-md-6 col-sm-6">
                            <div className="single-gallery mb-30">
                                <div className="gallery-img size-img" style={{ backgroundImage: `url(${gallery2})` }}></div>
                            </div>
                        </div>
                        <div className="col-lg-8 col-md-6 col-sm-6">
                            <div className="single-gallery mb-30">
                                <div className="gallery-img size-img" style={{ backgroundImage: `url(${gallery3})` }}></div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-gallery mb-30">
                                <div className="gallery-img size-img" style={{ backgroundImage: `url(${gallery4})`}}></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Team End */}
            {/* Testimonial Start */}
            <div className="testimonial-area testimonial-padding section-bg" data-background={sectionBg03}>
                <div className="container">
            ...
            <div className="contact-animal-owner section-bg" data-background={sectionBg04}>
                <div className="container">
